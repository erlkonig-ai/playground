...
pub mod playground_config {
    ...
    attributes! {
        "950B556A74F71AC7CB008AB23FBB6544" as pub system_prompt: Handle<LongString>;
        "35E36AE7B60AD946661BD63B3CD64672" as pub branch: Handle<LongString>;
        "F0F90572249284CD57E48580369DEB6D" as pub author: Handle<LongString>;
        "98A194178CFD7CBB915C1BC9EB561A7F" as pub author_role: Handle<LongString>;
        ...
        "85BE7BDA465B3CB0F800F76EEF8FAC9B" as pub model_name: Handle<LongString>;
        "B216CFBBF85AA1350B142D510E26268B" as pub model_base_url: Handle<LongString>;
        "55F3FFD721AF7C1258E45BC91CDBF30F" as pub model_api_key: Handle<LongString>;
        "328B29CE81665EE719C5A6E91695D4D4" as pub tavily_api_key: Handle<LongString>;
        "AB0DF9F03F28A27A6DB95B693CC0EC53" as pub exa_api_key: Handle<LongString>;
        "BA4E05799CA2ACDCF3F9350FC8742F2F" as pub model_reasoning_effort: Handle<LongString>;
        ...
        "120F9C6BBB103FAFFB31A66E2ABC15E6" as pub exec_default_cwd: Handle<LongString>;
...
pub fn build_playground_config_metadata() -> Fragment {
    playground_config::describe()
}
